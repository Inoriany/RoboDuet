...
class Cfg(PrefixProto, cli=False):
    ...
    class arm(PrefixProto, cli=False):
        ...
        # B2Z1 has 6 arm joints being controlled:
        # z1_waist, z1_shoulder, z1_elbow,
        # z1_wrist_angle, z1_forearm_roll, z1_wrist_rotate
    ...
    class viewer(PrefixProto, cli=False):
        pos = [1.5, 1.5, 1.0]      # 改为靠近机器人
        lookat = [0.0, 0.0, 0.5]   # 看点改为机器人中心
