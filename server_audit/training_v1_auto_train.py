...
def train_go1(arg):
    ...
    wandb.init(entity="yuxiaozhao-the-chinese-university-of-hong-kong",
               project="dev",
               group=args.run_name,
               mode=mode,
               notes=args.notes,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--robot', type=str, default="go1", choices=["go1", "go2", "b2z1"])
